...
export class DxDropDownButtonComponent extends DxComponent implements OnDestroy, OnChanges, DoCheck {
     ...
     */
    @Input()
    get dataSource(): Store | DataSourceOptions | DataSource | null | string | Array<dxDropDownButtonItem | any> {
        return this._getOption('dataSource');
    }
    set dataSource(value: Store | DataSourceOptions | DataSource | null | string | Array<dxDropDownButtonItem | any>) {
     ...
     */
    @Output() dataSourceChange: EventEmitter<Store | DataSourceOptions | DataSource | null | string | Array<dxDropDownButtonItem | any>>;
