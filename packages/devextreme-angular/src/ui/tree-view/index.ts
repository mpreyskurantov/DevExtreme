...
export class DxTreeViewComponent<TKey = any> extends DxComponent implements OnDestroy, OnChanges, DoCheck {
     ...
     */
    @Input()
    get dataSource(): Store | DataSourceOptions | DataSource | null | string | Array<dxTreeViewItem> {
        return this._getOption('dataSource');
    }
    set dataSource(value: Store | DataSourceOptions | DataSource | null | string | Array<dxTreeViewItem>) {
     ...
     */
    @Output() dataSourceChange: EventEmitter<Store | DataSourceOptions | DataSource | null | string | Array<dxTreeViewItem>>;
