...
export abstract class DxoHtmlEditorTableContextMenu extends NestedOption {
    ...
    get items(): Array<any | HtmlEditorPredefinedContextMenuItem | { beginGroup?: boolean, closeMenuOnClick?: boolean, disabled?: boolean, icon?: string, items?: Array<any | HtmlEditorPredefinedContextMenuItem>, name?: HtmlEditorPredefinedContextMenuItem | undefined, selectable?: boolean, selected?: boolean, template?: any, text?: string, visible?: boolean }> {
        return this._getOption('items');
    }
    set items(value: Array<any | HtmlEditorPredefinedContextMenuItem | { beginGroup?: boolean, closeMenuOnClick?: boolean, disabled?: boolean, icon?: string, items?: Array<any | HtmlEditorPredefinedContextMenuItem>, name?: HtmlEditorPredefinedContextMenuItem | undefined, selectable?: boolean, selected?: boolean, template?: any, text?: string, visible?: boolean }>) {
