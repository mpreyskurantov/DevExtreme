...
export abstract class DxiHtmlEditorImageUploadTabItem extends CollectionNestedOption {
    ...
    get groups(): Array<any | { commands?: Array<DevExpress.ui.dxDiagramCustomCommand | DiagramCommand>, title?: string }> {
        return this._getOption('groups');
    }
    set groups(value: Array<any | { commands?: Array<DevExpress.ui.dxDiagramCustomCommand | DiagramCommand>, title?: string }>) {
