...
export abstract class DxoHtmlEditorImageUpload extends NestedOption {
    ...
    get tabs(): Array<DevExpress.ui.dxHtmlEditorImageUploadTabItem | HtmlEditorImageUploadTab> {
        return this._getOption('tabs');
    }
    set tabs(value: Array<DevExpress.ui.dxHtmlEditorImageUploadTabItem | HtmlEditorImageUploadTab>) {
