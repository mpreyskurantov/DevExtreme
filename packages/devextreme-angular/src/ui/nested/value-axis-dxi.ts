...
import { AxisScaleType, ChartsAxisLabelOverlap, ChartsDataType, DashStyle, DiscreteAxisDivisionMode, RelativePosition, ScaleBreakLineStyle, TextOverflow, TimeIntervalConfig, VisualRangeUpdateMode, WordWrap } from 'devextreme/common/charts';
