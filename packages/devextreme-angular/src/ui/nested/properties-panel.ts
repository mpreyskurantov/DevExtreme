...
export class DxoPropertiesPanelComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
    get tabs(): Array<any | { commands?: Array<DevExpress.ui.dxDiagramCustomCommand | DiagramCommand>, groups?: Array<any | { commands?: Array<DevExpress.ui.dxDiagramCustomCommand | DiagramCommand>, title?: string }>, title?: string }> {
        return this._getOption('tabs');
    }
    set tabs(value: Array<any | { commands?: Array<DevExpress.ui.dxDiagramCustomCommand | DiagramCommand>, groups?: Array<any | { commands?: Array<DevExpress.ui.dxDiagramCustomCommand | DiagramCommand>, title?: string }>, title?: string }>) {
