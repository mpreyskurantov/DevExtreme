...
export class DxoToolboxComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
    get groups(): Array<any | DiagramShapeCategory | { category?: DiagramShapeCategory | string, displayMode?: DiagramToolboxDisplayMode, expanded?: boolean, shapes?: Array<DiagramShapeType | string>, title?: string }> {
        return this._getOption('groups');
    }
    set groups(value: Array<any | DiagramShapeCategory | { category?: DiagramShapeCategory | string, displayMode?: DiagramToolboxDisplayMode, expanded?: boolean, shapes?: Array<DiagramShapeType | string>, title?: string }>) {
