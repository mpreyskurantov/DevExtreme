...
import { ChartsDataType, DiscreteAxisDivisionMode, LabelOverlap, ScaleBreakLineStyle, TimeIntervalConfig } from 'devextreme/common/charts';
...
export class DxoScaleComponent extends NestedOption implements OnDestroy, OnInit  {
    ...
    @Input()
    get minorTickInterval(): number | undefined | TimeIntervalConfig | { days?: number, hours?: number, milliseconds?: number, minutes?: number, months?: number, quarters?: number, seconds?: number, weeks?: number, years?: number } {
        return this._getOption('minorTickInterval');
    }
    set minorTickInterval(value: number | undefined | TimeIntervalConfig | { days?: number, hours?: number, milliseconds?: number, minutes?: number, months?: number, quarters?: number, seconds?: number, weeks?: number, years?: number }) {
    ...
    @Input()
    get tickInterval(): number | undefined | TimeIntervalConfig | { days?: number, hours?: number, milliseconds?: number, minutes?: number, months?: number, quarters?: number, seconds?: number, weeks?: number, years?: number } {
        return this._getOption('tickInterval');
    }
    set tickInterval(value: number | undefined | TimeIntervalConfig | { days?: number, hours?: number, milliseconds?: number, minutes?: number, months?: number, quarters?: number, seconds?: number, weeks?: number, years?: number }) {
    ...
    @Input()
    get maxRange(): TimeIntervalConfig | number | { days?: number, hours?: number, milliseconds?: number, minutes?: number, months?: number, quarters?: number, seconds?: number, weeks?: number, years?: number } {
        return this._getOption('maxRange');
    }
    set maxRange(value: TimeIntervalConfig | number | { days?: number, hours?: number, milliseconds?: number, minutes?: number, months?: number, quarters?: number, seconds?: number, weeks?: number, years?: number }) {
    ...
    @Input()
    get minRange(): TimeIntervalConfig | number | { days?: number, hours?: number, milliseconds?: number, minutes?: number, months?: number, quarters?: number, seconds?: number, weeks?: number, years?: number } {
        return this._getOption('minRange');
    }
    set minRange(value: TimeIntervalConfig | number | { days?: number, hours?: number, milliseconds?: number, minutes?: number, months?: number, quarters?: number, seconds?: number, weeks?: number, years?: number }) {
