...
export class DxAccordionComponent<TItem = any, TKey = any> extends DxComponent implements OnDestroy, OnChanges, DoCheck {
     ...
     */
    @Input()
    get dataSource(): Store | DataSourceOptions | DataSource | null | string | Array<dxAccordionItem | string | any> {
        return this._getOption('dataSource');
    }
    set dataSource(value: Store | DataSourceOptions | DataSource | null | string | Array<dxAccordionItem | string | any>) {
     ...
     */
    @Output() dataSourceChange: EventEmitter<Store | DataSourceOptions | DataSource | null | string | Array<dxAccordionItem | string | any>>;
