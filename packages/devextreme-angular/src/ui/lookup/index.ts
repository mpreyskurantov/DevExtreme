...
export class DxLookupComponent extends DxComponent implements OnDestroy, ControlValueAccessor, OnChanges, DoCheck {
     ...
     */
    @Input()
    get dataSource(): Store | DataSourceOptions | DataSource | null | string | Array<CollectionWidgetItem | any> {
        return this._getOption('dataSource');
    }
    set dataSource(value: Store | DataSourceOptions | DataSource | null | string | Array<CollectionWidgetItem | any>) {
     ...
     */
    @Output() dataSourceChange: EventEmitter<Store | DataSourceOptions | DataSource | null | string | Array<CollectionWidgetItem | any>>;
