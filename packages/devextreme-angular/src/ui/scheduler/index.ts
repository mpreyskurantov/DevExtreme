...
export class DxSchedulerComponent extends DxComponent implements OnDestroy, OnChanges, DoCheck {
     ...
     */
    @Input()
    get dataSource(): Store | DataSourceOptions | DataSource | null | string | Array<dxSchedulerAppointment> {
        return this._getOption('dataSource');
    }
    set dataSource(value: Store | DataSourceOptions | DataSource | null | string | Array<dxSchedulerAppointment>) {
     ...
     */
    @Input()
    get resources(): Array<any | { allowMultiple?: boolean, colorExpr?: string, dataSource?: Store | DataSourceOptions | DataSource | null | string | Array<any>, displayExpr?: Function | string, fieldExpr?: string, label?: string, useColorAsDefault?: boolean, valueExpr?: Function | string }> {
        return this._getOption('resources');
    }
    set resources(value: Array<any | { allowMultiple?: boolean, colorExpr?: string, dataSource?: Store | DataSourceOptions | DataSource | null | string | Array<any>, displayExpr?: Function | string, fieldExpr?: string, label?: string, useColorAsDefault?: boolean, valueExpr?: Function | string }>) {
     ...
     */
    @Output() dataSourceChange: EventEmitter<Store | DataSourceOptions | DataSource | null | string | Array<dxSchedulerAppointment>>;
     ...
     */
    @Output() resourcesChange: EventEmitter<Array<any | { allowMultiple?: boolean, colorExpr?: string, dataSource?: Store | DataSourceOptions | DataSource | null | string | Array<any>, displayExpr?: Function | string, fieldExpr?: string, label?: string, useColorAsDefault?: boolean, valueExpr?: Function | string }>>;
