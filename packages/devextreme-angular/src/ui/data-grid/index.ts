...
export class DxDataGridComponent extends DxComponent implements OnDestroy, OnChanges, DoCheck {
     ...
     */
    @Input()
    get pager(): { allowedPageSizes?: Mode | Array<number | PagerPageSize>, displayMode?: PagerDisplayMode, infoText?: string, label?: string, showInfo?: boolean, showNavigationButtons?: boolean, showPageSizeSelector?: boolean, visible?: Mode | boolean } {
        return this._getOption('pager');
    }
    set pager(value: { allowedPageSizes?: Mode | Array<number | PagerPageSize>, displayMode?: PagerDisplayMode, infoText?: string, label?: string, showInfo?: boolean, showNavigationButtons?: boolean, showPageSizeSelector?: boolean, visible?: Mode | boolean }) {
     ...
     */
    @Output() pagerChange: EventEmitter<{ allowedPageSizes?: Mode | Array<number | PagerPageSize>, displayMode?: PagerDisplayMode, infoText?: string, label?: string, showInfo?: boolean, showNavigationButtons?: boolean, showPageSizeSelector?: boolean, visible?: Mode | boolean }>;
     ...
     */
    @Output() toolbarChange: EventEmitter<DevExpress.ui.dxDataGrid.dxDataGridToolbar | undefined>;
