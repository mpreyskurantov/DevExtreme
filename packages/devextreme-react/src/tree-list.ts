...
import type { ContentReadyEvent as PopupContentReadyEvent, DisposingEvent as PopupDisposingEvent, InitializedEvent as PopupInitializedEvent, dxPopupOptions, OptionChangedEvent as PopupOptionChangedEvent, HiddenEvent, HidingEvent, ResizeEvent, ResizeEndEvent, ResizeStartEvent, ShowingEvent, ShownEvent, TitleRenderedEvent, dxPopupToolbarItem } from "devextreme/ui/popup";
...
type IButtonProps = React.PropsWithChildren<{
  ...
  onClick?: ((e: { column: dxTreeListColumn, component: dxTreeList, element: any, event: event, row: dxTreeListRowObject }) => void);
